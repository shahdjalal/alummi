...
export default function ProfileBar() {
  ...
  const handleSaveEdit = async () => {
    try {
      ...
      await axios.put(`${import.meta.env.VITE_API_URL}/api/posts/edit/${editPostData.postId}`, formData, {
        headers: {
          Authorization: `${token}`,
  ...
  const handleDelete = async (postId) => {
    try {
      await axios.delete(`${import.meta.env.VITE_API_URL}/api/posts/delete/${postId}`, {
        headers: { Authorization: `${token}` },
      });
  ...
  const fetchFollowers = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/users/${user._id}/followers`);
  ...
  const fetchFollowing = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/users/${user._id}/following`);
